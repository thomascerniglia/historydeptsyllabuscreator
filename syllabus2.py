...
class HistorySyllabusGenerator:
    ...
    def add_ta(self):
        ...
        entries = []
        for label, width in [("Name:", 25), ("Email:", 30), ("Office Hours:", 45), ("Discussion Meeting Place:",30),("Discussion Meeting Time:",30)]:
        ...
        try:
            ...
            if hasattr(self, 'ta_entries'):
                for ta_entry_widgets in self.ta_entries:
                    if len(ta_entry_widgets) == 5: # Ensure it has name, email, hours, meeting place, time
                         content["tas"].append({
            ...
            if self.ta_entries:
                 ...
                 for ta_entry_widgets in self.ta_entries:
                     if len(ta_entry_widgets) == 5:
                         ...
                         self._add_preview_field(ta_frame, "Class Room:", ta_entry_widgets[3].get(), indent=0)
                         self._add_preview_field(ta_frame, "Class Time:", ta_entry_widgets[4].get(), indent=0)
